...
{
    internal static class WDALBModContentID
    {
        ...
        public static int GetSpookyBossNPCID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetSpookyBossNPCID() was called with an invalid ModContentID.");
            }
            return i;
        }
        public static int GetSpookyBossProjectileID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetSpookyBossProjectileID() was called with an invalid ModContentID.");
            }
            return i;
        }
        ...
        public static int GetSpiritBossNPCID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetSpiritBossNPCID() was called with an invalid ModContentID.");
            }
            return i;
        }
        public static int GetSpiritBossProjectileID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetSpiritBossProjectileID() was called with an invalid ModContentID.");
            }
            return i;
        }
        ...
        public static int GetConsolariaNPCID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetConsolariaNPCID() was called with an invalid ModContentID.");
            }
            return i;
        }
        ...
        public static DamageClass GetThoriumDamageClass(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetThoriumDamageClass() was called with an invalid ModContentID.");
                return null;
            }
            return i;
        }
        ...
        public static int GetThoriumBossNPCID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetThoriumBossNPCID() was called with an invalid ModContentID.");
            }
            return i;
        }
        public static int GetThoriumBossProjectileID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetThoriumBossProjectileID() was called with an invalid ModContentID.");
            }
            return i;
        }
        public static int GetThoriumItemID(int modContentID)
        {
            ...
            {
                WeDoALittleBalancing.logger.Fatal("WDALT: ERROR: GetThoriumItemID() was called with an invalid ModContentID.");
            }
            return i;
        }
        ...
        {
            bool integrity = true;
            if (WDALBModSystem.TryGetSpookyMod(out Mod spookyMod))
            {
            ...
            if (WDALBModSystem.TryGetSpiritMod(out Mod spiritMod))
            {
            ...
            if (WDALBModSystem.TryGetConsolariaMod(out Mod consolariaMod))
            {
            ...
            if (WDALBModSystem.TryGetThoriumMod(out Mod thoriumMod))
            {
